...
def load_analysis_page():
    ...
    with map1:
        ...
        with st.expander("Service Metrics"):
            ...
            st.metric('TTT contribution',("{:.2f}".format(round(service_metrics['ttt_contribution']/86400,2))))
            st.metric('TTT per metre',("{:.2f}".format(round(service_metrics['ttt_pm']/86400,2))))
            st.metric('Unique routes',("{:.2f}".format(round(service_metrics['num_routes'],2))))
            st.metric('Daily trips',("{:.2f}".format(round(service_metrics['trips_influenced'],2))))
